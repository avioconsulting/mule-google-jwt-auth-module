...
public class GoogleJWTAuth {
  ...
  public static String createJWT(String privateKeyId, String privateKey, String issuer, String user, String scopes,
      String audience) {
    try {
      // 1. Prepare Key
      // Strip any PEM headers/footers if present (just in case, though usually passed
      // raw base64)
